...
/**
 * Generate gear product images using Imagen 4 API
 * Usage: GEMINI_API_KEY="..." node scripts/generate-gear-images-v2.mjs
 */
...
async function main() {
  console.log(`\n🔥 Generating ${products.length} product images with Imagen 4...\n`);
